...
return [
	new Licence( 'PD', /^(PD|Public domain)\b/i, {
		'outputTemplate': 'ohne Urheberrechtsschutz'
	} ),
	...
	new Licence( 'cc-by-sa-3.0', 'CC BY-SA 3.0', 'http://creativecommons.org/licenses/by-sa/3.0/' ),
